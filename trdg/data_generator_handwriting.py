        ...
        # try:
            ...
            if background_type == 1:
                ...
                if distor_rnd < 0.15:
                    distorsion_type = 3          # 0 (None), 1 (Sin), 2 (Cos), 3 (Random)
                    distorsion_orientation = 0   # 0 (up-down),1 (left-right) ,2 (both)
                elif 0.15 <= distor_rnd < 0.2:
                    distorsion_type = 3  # 0 (None), 1 (Sin), 2 (Cos), 3 (Random)
                    distorsion_orientation = 1  # 0 (up-down),1 (left-right) ,2 (both)
                elif 0.2 <= distor_rnd < 0.22:
                    distorsion_type = 1  # 0 (None), 1 (Sin), 2 (Cos), 3 (Random)
                    distorsion_orientation = 2  # 0 (up-down),1 (left-right) ,2 (both)
                else:
                    distorsion_type = 0
            ...
            if rnd.random() < 0.7:
                if rnd.random() < 0.7:
                    ...
                    margins = (rnd.randint(4, 10), rnd.randint(30, 40), rnd.randint(4, 10), rnd.randint(30, 40))   # top, left, bottom, right

            else:
                fit = True
                margin_rand = rnd.randint(3, 6)
                # margins = (1, 1, 1, 1)
