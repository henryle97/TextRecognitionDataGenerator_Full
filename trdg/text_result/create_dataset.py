...
def createDataset(outputPath, root_dir, annotation_path, separate, size_gb=1):
    """
    ...
    env = lmdb.open(outputPath, map_size=size_gb * 1194302000)  # 4 bilion byte ~ 4GB
    cache = {}
    cnt = 0
    error = 0
...
if __name__ == "__main__":
    createDataset("./data_hw/hw_word_50k_dict_3k", root_dir="./", annotation_path="./hw_word_50k_dict_3k_labels.txt", separate='||||', size_gb=0.5)